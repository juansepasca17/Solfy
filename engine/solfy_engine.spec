...
for pkg in ("demucs", "torchcrepe", "librosa", "soundfile", "soxr", "faster_whisper", "ctranslate2", "julius", "openunmix", "dora"):
...
a = Analysis(
    ...
    binaries=binaries,
    datas=datas,
    hiddenimports=hiddenimports + ["solfy_engine.cli", "sklearn.utils._typedefs", "sklearn.neighbors._partition_nodes"],
